...
Nota: Los drivers son controladores de dispositivos externos.

### Relación Hardware-Software  

- __Disco duro__ :
almacena de forma permanente los archivos ejecutables y los archivos de datos. Se trata como un periférico actualmente.
...
El HD se considera actualmente un periférico de E/S.
La CPU se llama tb UCP en español, procesador o micro.
...
Sólo para lenguajes compilados: C, C++, Java.

En lenguajes interpretados no existe código objeto ni binario. Sólo código fuente. Por ejemplo: PHP, JavaScript, etc.
...
- La **especificación de requisitos** o **toma de requerimientos** debe:
  - Ser completa y sin omisiones
  - Ser concisa y sin trivialidades. Utilizar lenguaje formal.
  - Evitar ambigüedades
  - Evitar detalles de diseño o implementación
  - Ser entendible por el cliente
  - Separar requisitos funcionales y no funcionales (técnicos)
  - Dividir y jerarquizar el modelo
  - Fijar criterios de validación: entrega.


#### __DISEÑO__

- Serían las clases u objetos con que constará nuestra aplicación.
...
- Ingeniería de sistemas: __Especificación del sistema__ (muy común en software industrial)
...
- PRUEBAS del sistema: __Sistema aceptado__ (S.O., rendimiento, validación)
- Documentación: __Documentación técnica y de usuario__ (se puede hacer durane el desarrollo)
...
Notas: 
	el modelo predictivo se entiende como muy planificado, muy rígido.
...
Nota: importante los conceptos de "Validar" y "Verificar". Valida el cliente (qué) y se verifica según el diseño (cómo).
...
Notas: 	modelo muy especializados y sólo en la fase de análisis se hacen prototipos.
     	Python es muy apropiado para hacer prototipos.
...
Nota: es el modelo en V pero iterativo.
      en la fase de Ingeniería estaría el análisis, diseño, codificaciónn y pruebas.
...
Nota:	muy utilizado en la POO. Reutilizar las clases o desarrollarlas.
...
Nota:	se utilizan posits con colores: To do, Doing, Done
...
Nota: SCRUM (melé). Bakcklog del producto se segmenta en los backlog del sprint. El resultado se añade al producto.
...
Nota: Bakcklog del producto se segmenta en los backlog del sprint. El resultado se añade al producto.
...
Nota:	valentía y coraje: reconocer que hay alguien mejor.
...
Nota: 	refactorización: optimizar la legibilidad.
	programación por parejas: apoyo.
...
Notas: 	Prolog: hechos y reglas. Sistemas expertos e IA.
...
Nota: cómo de cerca están de la plataforma.
